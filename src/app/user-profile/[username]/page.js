import { fetchUser, fetchUserComments } from '@/utils/api';
              ...
              {comments.map((comment) => (
                <li key={comment.id} className='comment-item'>
                  <p className='comment-text'>
                    <strong>{comment.business_name}</strong>
                  </p>
                  ...
                  <form action={deleteComment}>
                    ...
                    <DeleteButton
                      classNames={
                        'bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-3 rounded-lg'
                      }
                      text='Delete'
                    />
                  </form>
